      ...
      <form onSubmit={handleQuery} style={{ marginBottom: 16 }}>
        <label>
          ...
          <input
            ...
            style={{ marginLeft: 8, padding: 4, borderRadius: 4, border: "1px solid #888", background: "#222", color: "#eee" }}
          />
        </label>
        <button type="submit" style={{ marginLeft: 12, padding: "4px 12px", borderRadius: 4, background: "#444", color: "#fff", border: "none" }}>
          Query
        </button>
      </form>
