...
const LicenseModal = ({ visible, initialPlan = "personal", onConfirm, onCancel }) => {
    ...
    <div className="modal-overlay">
      <div className="modal-content">
        ...
        <p className="modal-description">
          Select the license that best fits your use case to get started with Modix.
        </p>
        ...
        <div className="license-options">
          <label className="license-option">
            ...
            <div className="license-details">
              ...
              <p className="license-desc">Ideal for individual users running Modix on a single device.</p>
            </div>
          </label>
          ...
          <label className="license-option disabled">
            ...
            <div className="license-details">
              ...
              <p className="license-desc">For server hosting environments (currently unavailable).</p>
            </div>
          </label>
        </div>

        <div className="modal-actions">
          <button className="btn btn-primary" onClick={() => onConfirm(licensePlan)}>
            Confirm & Continue
          </button>
