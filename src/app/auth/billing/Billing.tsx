  ...
  return (
    <main className="min-h-screen bg-zinc-900 text-white px-6 py-12 flex flex-col items-center">
      ...
      <p className="text-gray-300 mb-12 text-center max-w-3xl leading-relaxed text-lg">
        Modix is always free to use for everyone via the{" "}
        <strong>Personal Plan</strong>. Simply apply for a free license and
        enjoy full access to core features for your hobby servers or personal
        projects.
        <br />
        <br />
        While Modix is free, your donations help fund server hosting,
        development of new tools, and keeping Modix alive for the long term.
        Every contribution — big or small — supports the community and ensures
      ...
      <p className="text-sm text-green-400 mt-10 text-center max-w-xl leading-relaxed">
        Modix is built for the long term. All users can enjoy free access to the
        Personal Plan, and donations help ensure Modix continues to grow,
        improve, and serve the community for years to come. Thank you for your
        support!
      </p>
    </main>
  );
